...
from app.api import auth, game, areas, submissions, leaderboard, admin, sessions, join, results, results_media, tikker, locations
...
app.include_router(tikker.router, prefix="/api")
